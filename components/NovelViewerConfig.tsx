                        ...
                        <div className="relative w-auto my-6 mx-auto max-w-sm">
                            <div className="writing-v-rl border-0 rounded shadow-lg relative flex flex-col w-full p-6 bg-white outline-none focus:outline-none">
                                ...
                                <div className="flex justify-end mr-4">
                                    <span
                                        className="h-12 gothic text-lg font-semibold text-gray-500 text-center border-r border-gray-400 border-opacity-0 hover:border-opacity-100 cursor-pointer"
