                ...
                <>
                    <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        <div className="relative w-auto my-6 mx-auto max-w-md">
                            <div className="gothic border-0 rounded shadow-lg relative flex flex-col w-full p-6 pb-4 bg-white outline-none focus:outline-none">
                                <input
                                    type="text"
                                ...
                                <div className="flex-center">
                                    <div className="flex justify-between w-72 opacity-80 mt-12">
                                        <span
                                            className="px-4 text-center font-semibold opacity-75 editor-bg border-b border-solid border-gray-300 cursor-pointer"
