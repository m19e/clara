...
export default function Top() {
    const [rootList] = useState([...Array(13)]);
        ...
        <Layout>
            <div className="flex-center">
                <div className="w-full flex flex-col flex-center mb-16">
                    <div className="flex justify-center flex-wrap items-end w-3/4 max-w-7xl">
                        {displayList.map((_, i) => (
                            <div className="w-full max-w-xl mt-8 mx-4 border-b border-solid border-gray-300">
