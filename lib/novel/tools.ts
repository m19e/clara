import { FirestoreFieldValue, FirestoreTimestamp } from "types";
...
export const createDisplayTimeFromTimestamp = (fv: FirestoreFieldValue): string => {
    const timestamp = fv as FirestoreTimestamp;
